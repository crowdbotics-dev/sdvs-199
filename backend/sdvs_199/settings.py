"""
Django settings for sdvs_199 project.
...
WSGI_APPLICATION = 'sdvs_199.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "sdvs_199 API",
    "DESCRIPTION": "API documentation for sdvs_199 App",
    "VERSION": "v1",
}
